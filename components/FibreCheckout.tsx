    ...
    <div className="w-full mb-12">
      <div className="flex items-center">
        <div className="flex items-center text-blue-600 relative">
          ...
          <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-blue-600">Details</div>
        </div>
                ...
                <h2 className="text-3xl font-bold tracking-tight text-slate-900 mb-8">Billing & Payment</h2>
                 <div className="space-y-10">
                  <div className="border-b border-gray-900/10 pb-12">
                    <h3 className="text-lg font-semibold leading-7 text-gray-900">Billing/Installation Address</h3>
  ...
  <div className="bg-white p-8 rounded-2xl shadow-lg sticky top-24">
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <span className="text-slate-600">Fibre - {packageName}</span>
